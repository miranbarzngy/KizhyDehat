            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-bold text-white">دابینکەر</h3>
                </div>
                <p className="text-slate-400 text-sm leading-relaxed">
                  زیادکردنی دابینکەران بۆ کڕینی کاڵا
                </p>
              </motion.div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-slate-300 text-sm">
                    <span className="text-white font-bold">دابینکەر:</span> ناتوانرێت سڕینەوەی دابینکەرێک ئەنجام بدرێت کە کاڵا بەناو زید کرابێت 
                  </p>
                </div>
              </motion.div>
            </div>
